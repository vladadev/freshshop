...
if (empty($search)) {
    $query = $conn->prepare(
        'SELECT * FROM slika_artikal sa INNER JOIN artikal a ON a.id_artikal = sa.artikal_id INNER JOIN slika s ON s.id_slika = sa.slika_id LIMIT :start, :range'
    );
} else {
    $query = $conn->prepare(
        'SELECT * FROM slika_artikal sa INNER JOIN artikal a ON a.id_artikal = sa.artikal_id INNER JOIN slika s ON s.id_slika = sa.slika_id WHERE a.naziv LIKE :search LIMIT :start, :range'
    );
    $bindSearch = '%' . $search . '%';
...
if (empty($search)) {
    $previousLink = NEW_BASE_URL . 'index.php?page=shop&start=' . $previous;
    $nextLink = NEW_BASE_URL . 'index.php?page=shop&start=' . $next;
} else {
    $previousLink =
        NEW_BASE_URL .
        'index.php?page=shop&start=' .
        $previous .
        '&search=' .
        $search;
    $nextLink =
                                                ...
                                                <div class="box-img-hover">
                                                    <div class="type-lb">
                                                        <?php if (
                                                            ...
                                                            <p class="sale"> <?php echo $itemArtikal[
                                                                'promocije'
                                                            ]; ?></p>
                                                        <?php else: ?>
                                                            <?php echo ''; ?>
                                                    ...
                                                    <div class="mask-icon">
                                                        <ul>
                                                            ...
                                                            <li><a href="<?php echo NEW_BASE_URL .
                                                        ...
                                                        <input 
                                                            ...
                                                            data-id-artikla="<?php echo $itemArtikal[
                                                                'id_artikal'
                                                            ]; ?>"
                                                            data-url="<?php echo NEW_BASE_URL; ?>"
                                                            value="Add to Cart" 
                                                        >
                                                    </div>
                                                </div>
                                                <div class="why-text">
                                                    <h4><?php echo $itemArtikal[
                                                        'naziv'
                                                    ]; ?></h4>
                                                    <h5> <?php echo '$' .
                                                        $itemArtikal[
                                                    ...
                                                    <div class="box-img-hover">
                                                        <div class="type-lb">
                                                            <?php if (
                                                                ...
                                                                <p class="sale"> <?php echo $valueListView[
                                                                    'promocije'
                                                                ]; ?></p>
                                                            <?php else: ?>
                                                                <?php echo ''; ?>
                                                        ...
                                                        <img src="images/artikli/<?php echo $valueListView[
                                                            'putanja'
                                                        ]; ?>" class="img-fluid" alt="<?php echo $valueListView[
    'alt'
]; ?>">
                                                        <div class="mask-icon">
                                                            <ul>
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                <div class="why-text full-width">
                                                    <h4><?php echo $valueListView[
                                                        'naziv'
                                                    ]; ?></h4>
                                                    <h5><?php echo $valueListView[
                                                        'cena'
                                                    ] . ' din'; ?></h5>
                                                    <p><?php echo $valueListView[
                                                        'opis'
                                                    ]; ?></p>
				...
				<div class="col-xl-3 col-lg-3 col-sm-12 col-xs-12 sidebar-shop-left">
                    <div class="product-categori">
                        <div class="search-product">
                            <form action="<?php echo NEW_BASE_URL .
                        ...
                        <div class="filter-sidebar-left">
                            ...
                            <div>
                                ...
                                <?php foreach ($rezultatCateg as $value): ?>

                                <div class="shop-category">
                                    <a class="kategorija" data-id-kategorije="<?php echo $value[
                                        'id_kategorija'
                                    ]; ?>"  
                                        data-url-kategorije="<?php echo NEW_BASE_URL; ?>"  
                                        href="#"> <?php echo $value[
                                            'naziv_kategorije'
                                        ]; ?> <small class="text-muted">(<?php echo $value[
     'kolicina_kategorije'
 ]; ?>)</small></a>
