...
try {
    ...
    $url =
        'location: ' .
        NEW_BASE_URL .
        'admin-pannel/admin-index.php?admin-page=artikal-update&error=Neuspesan update&artikal_id=' .
        $params['id'];
    header($url);
}
...
$url =
    'location: ' .
    NEW_BASE_URL .
    'admin-pannel/admin-index.php?admin-page=artikli&success=Uspesan update&artikal_id=' .
    $params['id'];
header($url);
