...
try {
    ...
    $url =
        'location: ' .
        NEW_BASE_URL .
        'admin-pannel/admin-index.php?admin-page=user-update&error=Update failed&artikal_id=' .
        $params['id'];
    header($url);
}
...
$url =
    'location: ' .
    NEW_BASE_URL .
    'admin-pannel/admin-index.php?admin-page=korisnici&success=User updated successfully&artikal_id=' .
    $params['id'];
header($url);
